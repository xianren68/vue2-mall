          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0" :class="{active:spuValue.isChecked === '1'}" v-for="spuValue in spuSaleAttr.spuSaleAttrValueList" :key="spuValue.id"
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model="sum" @change="changeSum">
                <a href="javascript:" class="plus" @click="sum++">+</a>
                <a href="javascript:" class="mins" @click="sum>1?sum--:sum=1">-</a>
              </div>
              <div class="add">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async addshopcar(){
        try {
          await this.$store.dispatch("shopcar",{
